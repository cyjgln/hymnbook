...
void AboutPage::setupUI()
{
    ...
    m_textBrowser->setHtml(QStringLiteral(
        ...
        "    <li><b>自动滚动</b> — 歌谱自动从顶部滚动到底部，速度 1-5 档可调（Space 启动/暂停）</li>"
        "    <li><b>显示模式</b> — 支持全页显示和横向最大化两种模式，可在设置中切换</li>"
        ...
        "    </tr>"
        "    <tr style='border-bottom: 1px solid #e0d5c8;'>"
        "      <td style='padding: 6px 12px; font-weight: bold;'>Space</td>"
        "      <td style='padding: 6px 12px;'>启动 / 暂停自动滚动</td>"
        "    </tr>"
        "    <tr style='border-bottom: 1px solid #e0d5c8;'>"
        "      <td style='padding: 6px 12px; font-weight: bold;'>0</td>"
        "      <td style='padding: 6px 12px;'>回到歌谱顶部</td>"
        "    </tr>"
        "    <tr style='border-bottom: 1px solid #e0d5c8;'>"
        "      <td style='padding: 6px 12px; font-weight: bold;'>Ctrl + ↑</td>"
        "      <td style='padding: 6px 12px;'>增加滚动速度</td>"
        "    </tr>"
        "    <tr style='border-bottom: 1px solid #e0d5c8;'>"
        "      <td style='padding: 6px 12px; font-weight: bold;'>Ctrl + ↓</td>"
        "      <td style='padding: 6px 12px;'>降低滚动速度</td>"
        "    </tr>"
        "    <tr style='border-bottom: 1px solid #e0d5c8;'>"
